...
<main id="main">
    ...
    if ( have_posts() ) :
            ...
            foreach ($sorted_results as $result) {
                ...
                <a href="<?php the_permalink() ?> ">
                    <div class="metainfo">
                        ...
                        <div class="line2">
                            <div class="entry-count"><?php get_search_query(); ?> comes up <?php echo $result['count']; ?> times in this post.</div>
                        </div>
                    </div>
                    <h2><?php the_title(); ?></h2>
                    <?php the_excerpt(); ?>
        ...
        echo "<section id='section' class='nosearch'>";
            echo "<div> We haven't found anything pertaining to ". get_search_query() .". Please try another query. </div>";
